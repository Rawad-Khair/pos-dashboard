            ...
            <li class="user-header">
              ...
              <p>
                ...
                @foreach(auth()->user()->roles as $role)
                  <span style="text-transform:capitalize">{{$role->display_name}}</span>
                <small>Member since {{$role->created_at->format('M Y')}}</small>
                @endforeach
              </p>
            </li>
            <!-- Menu Body -->
            ...
            <li class="user-footer">
              <div class="pull-left">
                <form action="{{route('logout')}}" method="POST">
                  {{csrf_field()}}
                  <button type="submit" class="btn btn-default btn-flat">@lang('dashboard.sign_out')</button>
                </form>
              </div>
              <div class="pull-left">
                <a
